package com.jasongj.kafka.streamx;
...
/**
 * 演示步骤：
 * 生产数据：bin\windows\kafka-console-producer.bat --broker-list localhost:9092,localhost:9093,localhost:9094 --topic topic-input
 * 消费数据：bin\windows\kafka-console-consumer.bat --bootstrap-server localhost:9092 --topic topicA --from-beginning
 */
public class StreamDemo {
    ...
    public static Map<String, Object> connection() {
        ...
        // 指定kafka集群
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka0:9092,kafka0:9093,kafka0:9094");
        // 指定一个路径创建改应用ID所属的文件
